...
export const PROGRAMS: Program[] = [
  ...
  { slug: "executive-program-in-business", title: "NABTEB A Level (General Education)", image: "/teacher-image.jpg", category: "NABTEB", blurb: "Intensive program for working executives ready for the next step." },
