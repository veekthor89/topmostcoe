...
export const PROGRAMS: Program[] = [
  ...
  { slug: "b-sc-in-biotechnology", title: "Professional B.Ed degree in Early Childhood and Primary \nEducation", image: "https://framerusercontent.com/images/SgQPOC1lvcPZAilklIFONMPEFw.png", category: "B.Sc / B.A / B.Ed Education", blurb: "Professional B.Ed degree in Early Childhood and Primary \nEducation in affiliation with Lagos State University, Ojo. \nDesigned for educators committed to foundational and early \nyears teaching." },
