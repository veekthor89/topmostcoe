...
export type Program = {
  ...
  title: string;
  image: string;
  category: "Vocational" | "Postgraduate" | "Degree" | "Online" | "Certificate" | "B.Sc / B.A / B.Ed Education" | "NCE" | "PDE" | "NABTEB" | "B.Sc / B.A / B.Ed Education";
  blurb: string;
};
...
export const PROGRAMS: Program[] = [
  ...
  { slug: "b-a-in-english-literature", title: "B.A Education — Arts & Humanities", image: "https://framerusercontent.com/images/7JyxFzbhwLWHTHMjN0jThMbL1Q.png", category: "NABTEB", blurb: "Explore literature, criticism and creative writing across cultures." },
