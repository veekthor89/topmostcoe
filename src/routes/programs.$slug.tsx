...
export const Route = createFileRoute("/programs/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          { title: `${loaderData.program.title} — TOPCOED` },
          { name: "description", content: loaderData.program.blurb },
          { property: "og:title", content: `${loaderData.program.title} — TOPCOED` },
    ...
    <article>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 prose prose-neutral">
        ...
        <p className="text-muted-foreground leading-relaxed mt-4">
          {program.title} at TOPCOED combines rigorous theory with hands-on practice. You'll work alongside award-winning faculty, collaborate with peers from 50+ countries, and graduate with a portfolio that opens doors at leading employers worldwide.
        </p>
